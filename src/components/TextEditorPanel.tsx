        ...
        <div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 rounded-md px-3 py-2 text-xs font-medium flex items-center justify-center gap-1.5 transition-colors ${
        ...
        <div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 rounded-md px-2 py-1.5 text-xs flex items-center justify-center transition-colors ${
